**1a Human Computer Interaction (HCI) Components and Norman's Principles (7½mks)**
...
*   Uses visual elements like icons, menus, windows, and buttons.
...
*   A display screen that is sensitive to touch input.
*   Allows users to interact directly with the interface by touching the screen.
*   Commonly used in smartphones, tablets, kiosks, and interactive displays.
*   Supports gestures like tapping, swiping, and pinching for interaction.
...
*   Users interact by typing text-based commands.
*   Provides powerful control and flexibility for experienced users.
*   Requires users to learn specific commands and syntax.
*   Examples: Command Prompt, Terminal, Linux shell.

**(v) Conversational User Interface (CUI):**

*   Enables interaction through natural language, either spoken or written.
*   Uses chatbots, voice assistants, and messaging interfaces.
*   Aims for a more natural and intuitive interaction style.
...
*   **Scenario-Based Design:**  Uses narratives or stories (scenarios) to describe how users might interact with a system in specific situations. Helps designers envision user interactions and design for real-world use cases.
...
*   **User Experience (UX):**  The overall experience a user has while interacting with a system, encompassing usability, aesthetics, emotion, and value.
*   **Functionality:**  Ensuring the system provides the necessary features and functions to meet user needs and goals.
*   **Aesthetics:**  The visual appeal and attractiveness of the interface, contributing to user satisfaction and engagement.
*   **Efficiency:**  How quickly and easily users can accomplish their tasks using the system.
...
**(i) General Interaction:**

*   Focuses on the overall interaction style and flow of the system.
*   Guidelines related to consistency, feedback, error prevention, and user control.
*   Ensures a smooth and intuitive user experience across the system.

**(ii) Information Display:**

*   Deals with how information is presented to the user on the interface.
*   Guidelines related to visual clarity, organization, use of graphics, typography, and color.
*   Aims to make information easily understandable and accessible to users.

**(iii) Data Entry:**

*   Concentrates on making data input efficient, accurate, and user-friendly.
*   Guidelines related to input validation, clear prompts, appropriate input methods (keyboard, form fields, etc.), and error handling during data entry.
*   Reduces user errors and improves data quality.


**3a Nielsen's Heuristics and User Interaction Ways (11mks)**

**(i) Highlight six principles of Nielsen that serves as a checklist in evaluating and explaining problems for the heuristic evaluator while auditing an interface or a product.** (6mks)

Six of Nielsen's 10 Heuristics for Heuristic Evaluation:
...
*   **Control:**  Directing the application's behavior and flow (e.g., navigating menus, starting/stopping processes).
...
*   Tools and techniques used to document and define user requirements and system specifications for HCI design.
*   Examples include:
    *   **Use Case Diagrams:**  Visual representations of user interactions with the system to achieve specific goals.
    *   **User Stories:**  Short, simple descriptions of features told from the user's perspective.
    *   **Wireframes:**  Low-fidelity visual representations of interface layouts, focusing on structure and content placement.

**(ii) Transition Diagram:**

*   Visual tools that represent the different states of a user interface and the possible transitions between these states.
*   Used to design and visualize the flow of user interaction and navigation within an application.
*   Help ensure that the user interface is logically structured and easy to navigate.

**(iii) Interface Building Tools:**

*   Software and libraries that simplify and accelerate the process of creating user interfaces.
*   Examples include:
    *   **GUI Builders:**  Visual development environments that allow designers to drag and drop UI elements and configure their properties (e.g., Qt Designer, Windows Forms Designer).
...
*   **Satisfaction:**  The comfort and acceptability of use. How pleasant or satisfying is the user experience?

**(ii) HCI design is considered as a problem-solving process that has components like planned usage, target area, resources, cost, and viability. Itemize the four basic activities of interaction design.** (4mks)
...
*   Testing conducted to determine if a product or system meets the user's needs and requirements and is acceptable for deployment or release.
*   Often performed at the end of the development process.
...
*   A display device that is sensitive to touch.
*   Allows users to interact directly with the displayed content by touching the screen with fingers or a stylus.
*   Used for input and output, replacing traditional mouse and keyboard in many applications.

**(ii) Gesture Recognition:**

*   Technology that enables computers to interpret and respond to human gestures.
*   Allows users to interact with systems using body movements, hand gestures, or facial expressions.
*   Offers a more natural and intuitive way to interact with technology, especially in virtual reality, gaming, and mobile devices.

**(iii) Speech Recognition:**

*   Technology that allows computers to understand and transcribe spoken language into text or commands.
*   Enables voice control of devices and applications, and speech-to-text input.
*   Used in voice assistants, dictation software, and hands-free interfaces.

**(iv) Keyboard:**

*   A traditional input device consisting of keys arranged in a layout.
*   Users type characters and commands by pressing keys.
